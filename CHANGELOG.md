...
## [v2.3.2](https://github.com/UtahGooner/sku-system/compare/v2.3.1...v2.3.2)

### Commits

- refactor(api): standardize API endpoints by appending `.json` suffix across modules and update associated parameters to improve consistency [`2629825`](https://github.com/UtahGooner/sku-system/commit/262982581e45b2b023fa2db2f1b33c1703042baf)

## [v2.3.1](https://github.com/UtahGooner/sku-system/compare/v2.3.0...v2.3.1) - 2026-09-09

### Commits

- refactor(ui): replace deprecated `color` prop with `variant` in SpinnerButton components and add `now` prop to ProgressBar for consistency [`9ea1468`](https://github.com/UtahGooner/sku-system/commit/9ea1468424c8598ffd6e25927cdac7c3cffbebf3)

## [v2.3.0](https://github.com/UtahGooner/sku-system/compare/v2.2.6...v2.3.0) - 2026-09-09

### Commits

- refactor: migrate build system from Webpack to Vite and replace outdated dependencies [`7296183`](https://github.com/UtahGooner/sku-system/commit/72961837142f70aaf87320d07bd217fe4ffa5e4e)

## [v2.2.6](https://github.com/UtahGooner/sku-system/compare/v2.2.5...v2.2.6) - 2026-01-19

### Commits

- chore: minimal updates to prevent a rebuild for something that should probably have been a major version update but it's in github instead of an npm repository. [`d018813`](https://github.com/UtahGooner/sku-system/commit/d018813de1ced33d39694b391e92ddb02a852cfe)
- refactor(api/items): enhance UPC assignment flow by checking existing UPC before generating new one [`b75bff5`](https://github.com/UtahGooner/sku-system/commit/b75bff5fcf0a9a5d502fa3c4fbc55be1248952aa)

## [v2.2.5](https://github.com/UtahGooner/sku-system/compare/v2.2.4...v2.2.5) - 2024-06-24
